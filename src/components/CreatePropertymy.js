...
const CreateProperty = () => {
  ...
  var externalArr = [];
  var buildingArr = [];
  if (singleData && singleData.property_type) {
    propertyArr = singleData.property_type.split(",");
  }

  // if (singleData && singleData.ready_to_sell) {
  //   propertyArr = singleData.ready_to_sell.split(",");
  // }

  if (singleData && singleData.external && singleData.external.garden_type) {
    externalArr =
      singleData.external && singleData.external.garden_type.split(",");
  }

  if (singleData && singleData.external && singleData.external.parking) {
    externalArr = singleData.external && singleData.external.parking.split(",");
  }

  if (singleData && singleData.building && singleData.building.style) {
    buildingArr = singleData.building.style.split(",");
  }

  if (singleData && singleData.building && singleData.building.condition) {
    buildingArr = singleData.building.condition.split(",");
  }

  if (singleData && singleData.building && singleData.building.windows) {
    buildingArr = singleData.building.windows.split(",");
  }
  ...
  if (
    ...
    buildingArr = singleData.building.period_features.split(",");
  }
  ...
  if (
    ...
    buildingArr = singleData.building.potential_expand.split(",");
  }

  if (singleData && singleData.building && singleData.building.heating) {
    buildingArr = singleData.building.heating.split(",");
  }
  ...
  const handleChangeCheckbox = (e) => {
    if (localStorage.getItem("propertyType") == "") {
      ...
      localStorage.setItem("propertyType", tempType);
    } else {
    ...
    console.log("updatechk", propertyType);
  };
                          ...
                          <div className="form-row  content-responsive">
                            ...
                            <div className="col-sm-6 ">
                              <input
                                ...
                                defaultChecked={
                                  ...
                                  propertyArr.indexOf("Detached") !== -1
                                    ? "checked"
                                    : ""
                                }
                                value="Detached"
                            ...
                            <div className="col-sm-6">
                              <input
                                ...
                                defaultChecked={
                                  singleData.property_type &&
                                  propertyArr.indexOf("Semi-Detached") !== -1
                                    ? "checked"
                                    : ""
                                }
                                value="Semi-Detached"
                          ...
                          <div className="form-row  content-responsive">
                            <div className="col-sm-6 ">
                              <input
                                ...
                                defaultChecked={
                                  singleData.property_type &&
                                  propertyArr.indexOf("Bungalow") !== -1
                                    ? "checked"
                                    : ""
                                }
                                value="Bungalow"
                                ...
                                <div className="form-row  content-responsive">
                                  ...
                                  <div className="col-sm-5 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.external.garden_type &&
                                        externalArr.indexOf("Landscaped") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      defaultValue={
                                  ...
                                  <div className="col-sm-4 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.external.garden_type &&
                                        externalArr.indexOf("Artificial") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      defaultValue={
                                ...
                                <div className="form-row  content-responsive">
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.external.parking &&
                                        externalArr.indexOf("Car Park") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      value="Car Park"
                                  ...
                                  <div className="col-sm-6">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.external.parking &&
                                        externalArr.indexOf("Private Road") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.external.parking &&
                                        externalArr.indexOf("Driveway") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      value="Driveway"
                                ...
                                <div className="form-row  content-responsive">
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.external.parking &&
                                        externalArr.indexOf("Single Garage") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.external.parking &&
                                        externalArr.indexOf("Double Garage") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                ...
                                <div className="form-row  content-responsive">
                                  ...
                                  <div className="col-sm-5 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        ...
                                        buildingArr.indexOf("New Build") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      value="New Build"
                                  ...
                                  <div className="col-sm-5 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.style &&
                                        buildingArr.indexOf("Townhouse") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      value="Townhouse"
                                  ...
                                  <div className="col-sm-4">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.style &&
                                        buildingArr.indexOf("Victorian") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      value="Victorian"
                                ...
                                <div className="form-row  content-responsive">
                                  ...
                                  <div className="col-sm-6">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.condition &&
                                        buildingArr.indexOf("Refurbished") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.condition &&
                                        buildingArr.indexOf("Requires Work") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                ...
                                <div className="form-row  content-responsive">
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        ...
                                        buildingArr.indexOf("Triple Glazed") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                  ...
                                  <div className="col-sm-6">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.windows &&
                                        buildingArr.indexOf("Double Glazed") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.windows &&
                                        buildingArr.indexOf("Single Glaze") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                ...
                                <div className="form-row  content-responsive">
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.period_features &&
                                        buildingArr.indexOf("High Ceilings") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.period_features &&
                                        buildingArr.indexOf("Cornicing") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      value="Cornicing"
                                  ...
                                  <div className="col-sm-6">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.period_features &&
                                        buildingArr.indexOf("Stain glass") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.period_features &&
                                        buildingArr.indexOf("Shutters") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      value="Shutters"
                                ...
                                <div className="form-row  content-responsive">
                                  <div className="col-sm-6">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.period_features &&
                                        buildingArr.indexOf("Thatched Roof") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                ...
                                <div className="form-row  content-responsive">
                                  ...
                                  <div className="col-sm-5 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.potential_expand &&
                                        propertyArr.indexOf("Side Return") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
                                ...
                                <div className="form-row  content-responsive">
                                  ...
                                  <div className="col-sm-5">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.heating &&
                                        propertyArr.indexOf("Fire Place") !== -1
                                          ? "checked"
                                          : ""
                                      }
                                      value="Fire Place"
                                  ...
                                  <div className="col-sm-6 ">
                                    <input
                                      ...
                                      defaultChecked={
                                        singleData.building.heating &&
                                        propertyArr.indexOf("Heated Floor") !==
                                          -1
                                          ? "checked"
                                          : ""
                                      }
